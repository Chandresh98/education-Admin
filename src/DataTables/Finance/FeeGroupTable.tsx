...
import * as FeeGroupColumn from '@/Columns/Finance/FeeGroupColumn'
export const FeeGroupTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: FeeGroupColumn.FeeGroupColumn,
        data,
