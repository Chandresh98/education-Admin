...
import * as StudyMaterialColumn from '@/Columns/Download-Center/StudyMaterialColumn'
export const StudyMaterialTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StudyMaterialColumn.StudyMaterialColumn,
        data,
