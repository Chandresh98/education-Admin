...
import * as DisableStaffColumn from '@/Columns/HR/DisableStaffColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const DisableStaffTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: DisableStaffColumn.DisableStaffColumn,
        data,
...
export default DisableStaffTable
