...
import * as PromoteStudentColumn from '@/Columns/Academic/PromoteStudentColumn'

export const PromoteStudentTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: PromoteStudentColumn.PromoteStudentColumn,
        data,
