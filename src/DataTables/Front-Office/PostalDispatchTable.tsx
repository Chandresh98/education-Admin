...
import * as PostalDispatchColumn from '@/Columns/Front-Office/PostalDispatchColumn'
export const PostalDispatchTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: PostalDispatchColumn.PostalDispatchColumn,
        data,
