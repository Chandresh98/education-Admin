...
import * as ComplainTypeColumn from '@/Columns/Front-Office/Set-Front-Office/ComplainTypeColumn'
export const ComplainTypeTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ComplainTypeColumn.ComplainTypeColumn,
        data,
