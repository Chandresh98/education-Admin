...
import * as AdmissionEnquiryColumn from '@/Columns/Front-Office/AdmissionEnquiryColumn'
export const AdmissionEnquiryTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: AdmissionEnquiryColumn.AdmissionEnquiryColumn,
        data,
