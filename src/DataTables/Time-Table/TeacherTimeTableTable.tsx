...
import * as TeacherTimeTableColumn from '@/Columns/Time-Table/TeacherTimeTableColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const TeacherTimeTableTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: TeacherTimeTableColumn.TeacherTimeTableColumn,
        data,
