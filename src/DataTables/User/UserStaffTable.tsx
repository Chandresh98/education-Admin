...
import * as UserStaffColumn from '@/Columns/User/UserStaffColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const UserStaffTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: UserStaffColumn.UserStaffColumn,
        data,
