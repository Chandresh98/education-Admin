...
import * as UserParentColumn from '@/Columns/User/UserParentColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const UserParentTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: UserParentColumn.UserParentColumn,
        data,
...
export default UserParentTable
