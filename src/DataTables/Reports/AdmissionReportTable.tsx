...
import * as AdmissionReportColumn from '@/Columns/Reports/AdmissionReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const AdmissionReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: AdmissionReportColumn.AdmissionReportColumn,
        data,
