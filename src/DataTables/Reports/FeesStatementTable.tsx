...
import * as FeesStatementColumn from '@/Columns/Reports/FeesStatementColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const FeesStatementTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: FeesStatementColumn.FeesStatementColumn,
        data,
...
export default FeesStatementTable
