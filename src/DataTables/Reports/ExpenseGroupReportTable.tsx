...
import * as ExpenseGroupReportColumn from '@/Columns/Reports/ExpenseGroupReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const ExpenseGroupReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ExpenseGroupReportColumn.ExpenseGroupReportColumn,
        data,
...
export default ExpenseGroupReportTable
