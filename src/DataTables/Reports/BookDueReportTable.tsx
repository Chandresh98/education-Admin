...
import * as BookDueReportColumn from '@/Columns/Reports/BookDueReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const BookDueReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: BookDueReportColumn.BookDueReportColumn,
        data,
...
export default BookDueReportTable
