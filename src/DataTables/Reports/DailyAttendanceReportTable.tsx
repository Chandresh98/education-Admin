...
import * as DailyAttendanceReportColumn from '@/Columns/Reports/DailyAttendanceReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const DailyAttendanceReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: DailyAttendanceReportColumn.DailyAttendanceReportColumn,
        data,
