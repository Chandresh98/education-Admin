...
import * as StudentHistoryColumn from '@/Columns/Reports/StudentHistoryColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const StudentHistoryTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StudentHistoryColumn.StudentHistoryColumn,
        data,
