...
import * as ParentUserLogColumn from '@/Columns/Reports/ParentUserLogColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const ParentUserLogTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ParentUserLogColumn.ParentUserLogColumn,
        data,
...
export default ParentUserLogTable
