...
import * as ExamsAttemptReportColumn from '@/Columns//Reports/ExamsAttemptReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const ExamsAttemptReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ExamsAttemptReportColumn.ExamsAttemptReportColumn,
        data,
...
export default ExamsAttemptReportTable
