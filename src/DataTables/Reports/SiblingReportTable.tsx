...
import * as SiblingReportColumn from '@/Columns//Reports/SiblingReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const SiblingReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: SiblingReportColumn.SiblingReportColumn,
        data,
...
export default SiblingReportTable
