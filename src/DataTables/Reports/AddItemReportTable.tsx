...
import * as AddItemReportColumn from '@/Columns/Reports/AddItemReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const AddItemReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: AddItemReportColumn.AddItemReportColumn,
        data,
...
export default AddItemReportTable
