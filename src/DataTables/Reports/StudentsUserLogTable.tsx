...
import * as StudentsUserLogColumn from '@/Columns/Reports/StudentsUserLogColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const StudentsUserLogTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StudentsUserLogColumn.StudentsUserLogColumn,
        data,
...
export default StudentsUserLogTable
