...
import * as StaffUserLogColumn from '@/Columns/Reports/StaffUserLogColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const StaffUserLogTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StaffUserLogColumn.StaffUserLogColumn,
        data,
...
export default StaffUserLogTable
