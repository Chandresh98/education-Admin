...
import * as RankReportColumn from '@/Columns/Reports/RankReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const RankReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: RankReportColumn.RankReportColumn,
        data,
...
export default RankReportTable
