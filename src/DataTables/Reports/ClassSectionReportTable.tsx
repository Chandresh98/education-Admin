...
import * as ClassSectionReportColumn from '@/Columns/Reports/ClassSectionReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const ClassSectionReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ClassSectionReportColumn.ClassSectionReportColumn,
        data,
...
export default ClassSectionReportTable
