...
import * as GuardianReportColumn from '@/Columns/Reports/GuardianReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const GuardianReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: GuardianReportColumn.GuardianReportColumn,
        data,
...
export default GuardianReportTable
