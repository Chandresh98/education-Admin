...
import * as AnnexureReportColumn from '@/Columns/Reports/AnnexureReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const AnnexureReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: AnnexureReportColumn.AnnexureReportColumn,
        data,
...
export default AnnexureReportTable
