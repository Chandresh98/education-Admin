...
import * as DailyCollectionReportColumn from '@/Columns/Reports/DailyCollectionReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const DailyCollectionReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: DailyCollectionReportColumn.DailyCollectionReportColumn,
        data,
