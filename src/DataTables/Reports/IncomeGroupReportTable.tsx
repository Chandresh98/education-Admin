...
import * as IncomeGroupReportColumn from '@/Columns/Reports/IncomeGroupReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const IncomeGroupReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: IncomeGroupReportColumn.IncomeGroupReportColumn,
        data,
...
export default IncomeGroupReportTable
