...
import * as BalanceFeesReportColumn from '@/Columns/Reports/BalanceFeesReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const BalanceFeesReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: BalanceFeesReportColumn.BalanceFeesReportColumn,
        data,
...
export default BalanceFeesReportTable
