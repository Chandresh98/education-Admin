...
import * as ClassSubjectReportColumn from '@/Columns/Reports/ClassSubjectReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const ClassSubjectReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: ClassSubjectReportColumn.ClassSubjectReportColumn,
        data,
...
export default ClassSubjectReportTable
