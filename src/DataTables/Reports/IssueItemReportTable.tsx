...
import * as IssueItemReportColumn from '@/Columns/Reports/IssueItemReportColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const IssueItemReportTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: IssueItemReportColumn.IssueItemReportColumn,
        data,
...
export default IssueItemReportTable
