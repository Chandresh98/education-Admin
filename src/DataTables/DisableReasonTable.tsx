...
import * as DisableReasonColumn from '@/Columns/DisableReasonColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const DisableReasonTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: DisableReasonColumn.DisableReasonColumn,
        data,
...
export default DisableReasonTable
