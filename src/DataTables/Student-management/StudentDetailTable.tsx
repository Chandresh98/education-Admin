...
import * as StudentDetailColumn from '@/Columns/Student-management/studentDetailColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const StudentDetailTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StudentDetailColumn.StudentDetailColumn,
        data,
