...
import * as OnlineAdmissionColumn from '@/Columns/Student-management/OnlineAdmissionColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const OnlineAdmissionTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: OnlineAdmissionColumn.OnlineAdmissionColumn,
        data,
