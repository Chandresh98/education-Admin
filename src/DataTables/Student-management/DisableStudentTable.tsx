...
import * as DisableStudentColumn from '@/Columns/Student-management/DisableStudentColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const DisableStudentTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: DisableStudentColumn.DisableStudentColumn,
        data,
...
export default DisableStudentTable
