...
import * as StudentCategoryColumn from '@/Columns/StudentCategoryColumn'

export const StudentCategoryTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: StudentCategoryColumn.StudentCategoryColumn,
        data,
