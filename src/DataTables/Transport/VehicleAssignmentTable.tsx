...
import * as VehicleAssignmentColumn from '@/Columns/Transport/VehicleAssignmentColumn'
// import { SessionColumn } from '@/Columns/SessionColumn'

export const VehicleAssignmentTable = () => {
    ...
    const table = useMaterialReactTable({
        columns: VehicleAssignmentColumn.VehicleAssignmentColumn,
        data,
