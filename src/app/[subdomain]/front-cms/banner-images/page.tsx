'use client'
import { BannerImagesForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { BannerImagesParams } from '@/types/FormType'
...
const BannerImages = () => {
    ...
    } = useForm<BannerImagesParams>({
        resolver: zodResolver(BannerImagesForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<BannerImagesParams> = async (
        data: BannerImagesParams,
    ) => {
        // console.log(data)
