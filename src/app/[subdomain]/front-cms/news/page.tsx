'use client'
import { NewsForm } from '@/Schemas/Schema'
...
import NewsTable from '@/DataTables/Front-CMS/NewsTable'
...
const News = () => {
    const {
        ...
        resolver: zodResolver(NewsForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<NewsParams> = async (data: NewsParams) => {
        // console.log(data)
