'use client'
import { VehicleFuelForm } from '@/Schemas/Schema'
...
import VehicleFuelTable from '@/DataTables/Transport/VehicleFuelTable'
...
const VehicleFuel = () => {
    ...
    } = useForm<VehicleFuelParams>({
        resolver: zodResolver(VehicleFuelForm, {}, { raw: true }),
    })

    const VehicleFuelr = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<VehicleFuelParams> = async (
        data: VehicleFuelParams,
    ) => {
        // console.log(data)
