'use client'
// import { PurposeForm } from '@/Schemas/Schema'
...
import PurposeTable from '@/DataTables/Front-Office/Set-Front-Office/PurposeTable'
...
const Purpose = () => {
    ...
    } = useForm<PurposeParams>({
        // resolver: zodResolverPurposeForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<PurposeParams> = async (
        data: PurposeParams,
    ) => {
        // console.log(data)
