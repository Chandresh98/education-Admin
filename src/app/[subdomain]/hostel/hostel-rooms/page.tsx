'use client'
import { HostelRoomsForm } from '@/Schemas/Schema'
...
import HostelRoomsTable from '@/DataTables/Hostel/HostelRoomsTable'
...
const HostelRooms = () => {
    ...
    } = useForm<HostelRoomsParams>({
        resolver: zodResolver(HostelRoomsForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<HostelRoomsParams> = async (
        data: HostelRoomsParams,
    ) => {
        // console.log(data)
