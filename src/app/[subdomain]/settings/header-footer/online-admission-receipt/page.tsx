'use client'
import { OnlineAdmissionReceiptForm } from '@/Schemas/Schema'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'

import axios from '@/lib/axios'
import { OnlineAdmissionReceiptParams } from '@/types/FormType'
...
const OnlineAdmissionReceipt = () => {
    const {
        register,
        handleSubmit,
        formState: { errors, isSubmitting },
        setValue,
    } = useForm<OnlineAdmissionReceiptParams>({
        resolver: zodResolver(OnlineAdmissionReceiptForm, {}, { raw: true }),
    })
    ...
    const handleImageChange = (file: File | null) => {
        setHeaderImage(file)
        setValue('header_image', file as any)
    }

    const onSubmit: SubmitHandler<OnlineAdmissionReceiptParams> = async (
        data: OnlineAdmissionReceiptParams,
    ) => {
                    ...
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        <form action="" onSubmit={handleSubmit(onSubmit)}>
                            <div className="p-6.5">
                                ...
                                <div className="w-full mb-4 font-sm text-black dark:text-white ">
                                    <textarea
                                        value={text}
...
export default OnlineAdmissionReceipt
