'use client'
import { FeesReceiptForm } from '@/Schemas/Schema'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'

import axios from '@/lib/axios'
import { FeesReceiptParams } from '@/types/FormType'
...
const FeesReceipt = () => {
    const {
        ...
        setValue,
    } = useForm<FeesReceiptParams>({
        resolver: zodResolver(FeesReceiptForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<FeesReceiptParams> = async (
        data: FeesReceiptParams,
    ) => {
