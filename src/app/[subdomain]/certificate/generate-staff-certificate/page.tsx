'use client'
import { GenerateStaffCertificateForm } from '@/Schemas/Schema'
...
import GenerateStaffCertificateTable from '@/DataTables/Certificate/GenerateStaffCertificateTable'
...
const GenerateStaffCertificate = () => {
    ...
    } = useForm<GenerateStaffCertificateParams>({
        resolver: zodResolver(GenerateStaffCertificateForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<GenerateStaffCertificateParams> = async (
        data: GenerateStaffCertificateParams,
    ) => {
        // console.log(data)
...
export default GenerateStaffCertificate
