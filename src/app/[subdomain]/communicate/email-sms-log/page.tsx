'use client'
import { EmailSMSLogForm } from '@/Schemas/Schema'
...
import EmailSMSLogTable from '@/DataTables/Communicate/EmailSMSLogTable'
...
const EmailSMSLog = () => {
    ...
    } = useForm<EmailSMSLogParams>({
        resolver: zodResolver(EmailSMSLogForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<EmailSMSLogParams> = async (
        data: EmailSMSLogParams,
    ) => {
        // console.log(data)
