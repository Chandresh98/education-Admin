'use client'
import { IndividualForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { IndividualParams } from '@/types/FormType'
...
const Individual = () => {
    ...
    } = useForm<IndividualParams>({
        resolver: zodResolver(IndividualForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<IndividualParams> = async (
        data: IndividualParams,
    ) => {
        // console.log(data)
