'use client'
import { ClassSMSForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { ClassSMSParams } from '@/types/FormType'
...
const ClassSMS = () => {
    ...
    } = useForm<ClassSMSParams>({
        resolver: zodResolver(ClassSMSForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<ClassSMSParams> = async (
        data: ClassSMSParams,
    ) => {
        // console.log(data)
