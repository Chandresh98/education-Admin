'use client'
import { GroupSMSForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { GroupSMSParams } from '@/types/FormType'
...
const GroupSMS = () => {
    ...
    } = useForm<GroupSMSParams>({
        resolver: zodResolver(GroupSMSForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<GroupSMSParams> = async (
        data: GroupSMSParams,
    ) => {
        // console.log(data)
