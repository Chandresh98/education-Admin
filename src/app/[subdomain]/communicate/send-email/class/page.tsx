'use client'
import { ClassEmailForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { ClassEmailParams } from '@/types/FormType'
...
const ClassEmail = () => {
    ...
    } = useForm<ClassEmailParams>({
        resolver: zodResolver(ClassEmailForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<ClassEmailParams> = async (
        data: ClassEmailParams,
    ) => {
        // console.log(data)
                        ...
                        <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                            <div className=" w-100 gap-6 mr-6.5">
                                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                                    ...
                                    <div className=" font-medium text-black dark:text-white  px-6.5 py-3 w-full mb-4.5 h-70">
                                        Section
                                    </div>
                                </div>
                            </div>
