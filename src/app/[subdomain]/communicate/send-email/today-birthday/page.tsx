'use client'
import { TodayBirthdayEmailForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { TodayBirthdayEmailParams } from '@/types/FormType'
...
const TodayBirthdayEmail = () => {
    const {
        register,
        handleSubmit,
        formState: { errors, isSubmitting },
    } = useForm<TodayBirthdayEmailParams>({
        resolver: zodResolver(TodayBirthdayEmailForm, {}, { raw: true }),
    })
    ...
    const onSubmit: SubmitHandler<TodayBirthdayEmailParams> = async (
        data: TodayBirthdayEmailParams,
    ) => {
        // console.log(data)
...
export default TodayBirthdayEmail
