'use client'
import { DisableStudentForm } from '@/Schemas/Schema'
import Input from '@/components/Forms/Input'
import DefaultLayout from '@/components/Layouts/DefaultLayout'
import { useToast } from '@/hooks/toast'
import axios from '@/lib/axios'
import { DisableStudentParams } from '@/types/FormType'
import { zodResolver } from '@hookform/resolvers/zod'
import { Button } from 'primereact/button'
import { useRouter } from 'next/navigation'
import { SubmitHandler, useForm } from 'react-hook-form'
import DisableStudentTable from '@/DataTables/Student-management/DisableStudentTable'
...
const DisableStudent = () => {
    ...
    } = useForm<DisableStudentParams>({
        resolver: zodResolver(DisableStudentForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<DisableStudentParams> = async (
        data: DisableStudentParams,
    ) => {
        // console.log(data)
