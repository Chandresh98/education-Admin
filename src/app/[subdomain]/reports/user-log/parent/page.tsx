'use client'
// import { ParentUserLogForm } from '@/Schemas/Schema'
...
import ParentUserLogTable from '@/DataTables/Reports/ParentUserLogTable'
const ParentUserLog = () => {
    const {
        register,
        handleSubmit,
        formState: { errors, isSubmitting },
    } = useForm<ParentUserLogParams>({
        // resolver: zodResolver(ParentUserLogForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<ParentUserLogParams> = async (
        data: ParentUserLogParams,
    ) => {
        // console.log(data)
