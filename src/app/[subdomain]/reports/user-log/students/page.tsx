'use client'
// import { StudentsUserLogForm } from '@/Schemas/Schema'
...
import StudentsUserLogTable from '@/DataTables/Reports/StudentsUserLogTable'
const StudentsUserLog = () => {
    const {
        register,
        handleSubmit,
        formState: { errors, isSubmitting },
    } = useForm<StudentsUserLogParams>({
        // resolver: zodResolver(studentsForm, {}, { raw: true }),
    })

    const router = useRouter()
    const { ToastError, ToastSuccess } = useToast()

    const onSubmit: SubmitHandler<StudentsUserLogParams> = async (
        data: StudentsUserLogParams,
    ) => {
        // console.log(data)
...
export default StudentsUserLog
